...
<html>
  ...
  <frameset rows="64,*,30"  frameborder="NO" border="0" framespacing="0">
	<frame src="head.jsp" noresize="noresize" frameborder="NO" name="topFrame" scrolling="no" marginwidth="0" marginheight="0" target="main" />
  <frameset cols="240,*"  rows="560,*" id="frame">
	<frame src="menu.jsp" name="leftFrame" noresize="noresize" margsinwidth="0" marginheight="0" frameborder="0" scrolling="yes" target="main" />
